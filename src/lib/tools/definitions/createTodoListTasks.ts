...
export const definition: ToolDefinition = {
  ...
  description: 'Create multiple tasks in the agentic to-do list at once. Use this to decompose a complex request into a complete plan of tasks upfront. Returns an array of task IDs which you should store to update their status later.',
  category: 'system',
  parameters: {
    type: 'object',
    properties: {
      tasks: {
        ...
        items: {
          ...
          properties: {
            ...
            dependencies: { type: 'array', items: { type: 'string' }, description: 'Array of task IDs (or local references) that must be completed before this one. Leave empty if none.' },
