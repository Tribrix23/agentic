...
export function buildPlanModeContract(): string {
  return [
    ...
    'Do not forget the Closing tags </ARGUMENT_NAME>, </invoke> and </tool_call> if you forget these then the tool call will fail and user will be notified about the error.',
