...
contextBridge.exposeInMainWorld('electron', {
  ...
  environment: {
    ...
    previewInstall: (input: any) => ipcRenderer.invoke('environment-preview-install', input),
    startInstall: (plan: any) => ipcRenderer.invoke('environment-start-install', plan),
    startPythonInstall: (plan: any) => ipcRenderer.invoke('environment-start-python-install', plan),
    startJavaInstall: (plan: any) => ipcRenderer.invoke('environment-start-java-install', plan),
    ...
    searchPythonPackages: (query: string, projectRoot?: string) => ipcRenderer.invoke('environment-search-python-packages', query, projectRoot),
  ...
  startLiveServer: (path: string, initialFile?: string) => ipcRenderer.invoke('start-live-server', path, initialFile),
  openLiveServerFile: (port: number, file: string) => ipcRenderer.invoke('open-live-server-file', port, file),
  ...
  getRunCommandForFile: (filePath: string, cwd: string) => ipcRenderer.invoke('get-run-command-for-file', filePath, cwd),
