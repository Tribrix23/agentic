    ...
    <>
      ...
      {isOpen && (
        <div
          ...
          // both modes.
          className="fixed z-50 px-2 py-1 text-xs font-medium text-[color:var(--doc-text-on-surface,#1f2937)] bg-white border border-[color:var(--doc-border,#dadce0)] rounded-md shadow-lg"
          style={{
            left: position.x,
            top: position.y,
            transform:
